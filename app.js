...
riot.tag2('comp-main', '<comp-menu ref="menuComp"></comp-menu> <comp-topbar ref="topbarComp"></comp-topbar> <div class="welcome-card"> <div class="logo"> <img src="img/logo-white.svg" alt="PeerAssets"> </div> <div class="content"> <h1>PeerAssets Whitepaper</h1> <h2>This paper describes a simple, blockchain agnostic protocol which enables peers to issue and transact with assets.</h2> <h3>by: Peerchemist (peerchemist@protonmail.ch), April, 2016.</h3> </div> </div> <div class="doc-container" ref="docContainer"> </div>', '', '', function(opts) {
    this.fontSize = 2;
    this.on('mount', () => {
      this.registerDocumentation();
    });

    this.registerDocumentation = function () {
...
require.register("components/MenuComp.tag", function(exports, require, module) {
riot.tag2('comp-menu', '<div class="MenuComp--overlay" ref="overlay" onclick="{close}"></div> <div class="MenuComp" ref="menu"> <div class="logo"> <img src="img/logo.svg" alt="PeerAssets WhitePaper"> </div> <ul class="menu"> <li each="{menu}" onclick="{scroll}" class="{type} {active: active}">{label}</li> </ul> </div>', '', '', function(opts) {
    this.isOpen = false;
    this.menu = [];
    this.on('mount', () => {
      window.onscroll = (e) => {
    ...
    this.generateMenu = function (documentationElement) {
...
riot.tag2('comp-topbar', '<div class="TopbarComp"> <div class="menu-button" onclick="{toggleMenu}"> <img class="{off: parent.refs.menuComp.isOpen}" src="img/icon-menu-open.svg" width="20" alt="Open Menu"> <img class="{off: !parent.refs.menuComp.isOpen}" src="img/icon-menu-close.svg" width="15" alt="Open Menu"> </div> <div class="btn-group"> <div class="btn" onclick="{fontMinus}"> <img src="img/icon-font-minus.svg" alt="Smaller font"> </div> <div class="btn" onclick="{fontPlus}"> <img src="img/icon-font-plus.svg" alt="Smaller font"> </div> </div> <a href="https://github.com/PeerAssets/WhitePaper" class="btn">Visit Github Project</a> </div>', '', '', function(opts) {
...
var _MenuComp = require('./components/MenuComp');
